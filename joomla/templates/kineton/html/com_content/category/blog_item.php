...
<?php endif; ?>
	...
	<div class="gk-article-blog" data-scrollReveal="enter from the top after 0.3s ease-out">
	...
	<aside>
		...
		<time datetime="<?php echo JHtml::_('date', $this->item->publish_up, 'Y-m-d'); ?>">
			<span class="day"><?php echo JHtml::_('date', $this->item->publish_up, JText::_('d')); ?></span>
			<span class="month"><?php echo JHtml::_('date', $this->item->publish_up, JText::_('M')); ?>&nbsp;<?php echo JHtml::_('date', $this->item->publish_up, JText::_('Y')); ?></span>
		</time>
		<?php endif; ?>
